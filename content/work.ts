...
export const works: WorkItem[] = [
  {
    slug: "kova-cosmetics",
    title: "Bold Beauty, Zero Compromise",
    year: "2026",
    date: "2026-03",
    category: "Beauty Campaign",
    hook: "Mascara that demands attention. Campaign that delivers.",
    solution: "High-impact visuals with product-first storytelling that converts scrollers into buyers.",
    challenge: "KOVA needed a launch campaign that would cut through the saturated beauty market while maintaining premium positioning across all touchpoints.",
    approach: "We built a cohesive visual system centered on bold makeup looks and product close-ups. Every asset was optimized for social-first consumption with platform-native aspect ratios.",
  ...
  },
  {
    ...
    hook: "American muscle meets Mediterranean soul. A concept that bridged two worlds.",
    solution: "Photorealistic CGI renders placing a widebody Shelby GT350 against Alexandria's iconic Stanley Bridge at golden hour.",
    challenge: "Create a viral-worthy concept series showcasing a classic American muscle car in an unexpected Egyptian setting, appealing to both car enthusiasts and luxury lifestyle audiences.",
    approach: "We combined studio-lit garage renders with sunset composites at Stanley Bridge, Alexandria. The widebody kit design pushed heritage styling into modern aggressive territory while the location choice honored the Alexandria → GCC market positioning.",
  ...
  },
  {
    ...
    challenge: "TAG Heuer needed a digital campaign that conveyed the Carrera's mechanical heritage without falling into the cliché of close-up gear shots.",
    approach: "We built a visual system around macro photography with restrained color grading — letting the movement's precision speak through composition rather than post-production tricks.",
    tags: ["Luxury", "Watch", "Precision"],
    cover: "/images/work/tag-heuer-carrera/cover.webp",
    gallery: [],
    featured: true,
    video: null,
  ...
  },
  {
    ...
    challenge: "MISSHA's Time Revolution line needed a motion-first campaign that could compete in fast-scroll environments while preserving premium positioning.",
    approach: "We developed a vertical-native motion language with precise rhythm control. Every transition preserves product texture at mobile resolution.",
  ...
  },
  {
    ...
    challenge: "Launch a new skincare line in a crowded market with limited budget but maximum impact requirements.",
    approach: "We created a modular content system where every asset could be remixed across platforms while maintaining brand consistency.",
    tags: ["Skincare", "Launch System", "Platform Design"],
    cover: "/images/work/modern-skincare/cover.webp",
    gallery: [],
    featured: true,
    video: null,
