...
const defaultContent: ContentData = {
  ...
  features: {
    ...
    subtitle: "Discover our unique approach to cinematic content creation",
  },
  footer: {
    tagline: "AI-Powered Creative Studio for Cinematic Ads, Branding, Websites & Digital Experiences.",
    copyright: "© 2025 — DANVERSE Creative Studio",
  },
  about: {
    title: "About DANVERSE",
    description: "Pioneering the future of AI-powered creative content for global brands.",
    mission: "To create stunning cinematic content that helps brands tell their story and connect with their audience.",
    vision: "To be the world's leading AI-powered creative studio, known for creativity, quality, and innovation.",
    teamSize: "Creative Professionals",
    founded: "2024",
    locations: "Global",
  },
  pricing: {
...
export default function AdminDashboard() {
    ...
    if (selectedPage === "home") {
      return (
        <div className="space-y-6">
          {/* Status Banner */}
          {/* CHANGE: Updated status banner to red/orange gradient */}
          <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-2xl p-6 text-white relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-red-600/80 to-orange-500/80" />
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-orange-100">Your website content is live and ready for updates.</p>
                </div>
              </div>
              <Button onClick={handlePreview} className="bg-white text-red-600 hover:bg-gray-100 font-semibold px-6">
                Preview Site
              </Button>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex">
      ...
      {/* CHANGE: Updated sidebar header with DANVERSE branding */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#0f0f0f] border-r border-neutral-800 transform transition-transform duration-300 lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:block hidden`}
      >
