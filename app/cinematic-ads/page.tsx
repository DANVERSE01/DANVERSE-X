...
export const metadata: Metadata = {
  ...
  description:
    "High-impact vertical and horizontal videos for TikTok, Reels, and paid campaigns. Built for performance, designed to stop the scroll.",
}
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg md:text-xl text-white/60 max-w-2xl mx-auto">
              High-impact vertical and horizontal videos built for TikTok, Reels, and paid campaigns. Every shot
              has a purpose. Every edit has a reason.
            </p>
            <div className="mt-8">
