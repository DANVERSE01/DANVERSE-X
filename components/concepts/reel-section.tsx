...
const CLIPS = [
  {cat:"BRAND",   title:"Luxury Motion",  fmt:"4K - 60FPS",         src:"/videos/conversions.mp4",  bg:"#0a0404"},
  {cat:"SAAS",    title:"Tech Reveal",    fmt:"9:16 - Social",      src:"/videos/speed.mp4",        bg:"#04040a"},
  {cat:"AD",      title:"Product Macro",  fmt:"3D - VFX",           src:"/videos/social-ready.mp4", bg:"#0a0a04"},
  {cat:"FILM",    title:"Dynamic Flow",   fmt:"Color Graded",       src:"/videos/standout.mp4",     bg:"#040a04"},
  {cat:"B2B",     title:"Elite Systems",  fmt:"Animation",          src:"/videos/premium.mp4",      bg:"#0a0404"},
  {cat:"AI",      title:"Vision 2026",    fmt:"Generative Art",     src:"/videos/conversions.mp4",  bg:"#04040a"},
  {cat:"IDENTITY",title:"Brand Core",     fmt:"Logo - Motion",      src:"/videos/speed.mp4",        bg:"#080408"},
  {cat:"UI/UX",   title:"Future Sprints", fmt:"Interactive",        src:"/videos/social-ready.mp4", bg:"#040808"},
  {cat:"EDU",     title:"Master Class",   fmt:"Long Form",          src:"/videos/standout.mp4",     bg:"#080804"},
]
...
export function ReelSection() {
  ...
  const stop = useCallback(() => { if (auto.current) { clearInterval(auto.current); auto.current=null } }, [])
    ...
    <section style={{background:"#000",borderTop:"1px solid rgba(255,255,255,0.04)"}} onMouseEnter={stop} onMouseLeave={start}>
      ...
      <div style={{width:"100%"}}>
        ...
        <div style={{display:"flex",gap:"2px",padding:"0 clamp(24px,6vw,80px)",paddingBottom:"48px",overflowX:"auto",scrollbarWidth:"none"}}>
          {CLIPS.map((c,i) => (
            <button key={i} onClick={() => {stop();setActive(i)}} style={{flexShrink:0,width:"clamp(80px,8vw,120px)",background:"none",border:"none",cursor:"pointer",padding:0,opacity:i===active?1:0.3,transition:"opacity 0.3s"}}>
