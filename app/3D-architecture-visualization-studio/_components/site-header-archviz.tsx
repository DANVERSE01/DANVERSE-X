      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex h-14 items-center justify-between px-6 liquid-glass-header rounded-full">
          <Link href="/3D-architecture-visualization-studio" className="flex items-center gap-1.5">
            <Image src="/images/danverse-logo.png" alt="DANVERSE logo" width={40} height={40} className="h-10 w-10 object-contain" />
            <span className="font-semibold tracking-wide text-white">DANVERSE ArchViz</span>
          </Link>
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="liquid-glass border-gray-800 p-0 w-64 flex flex-col">
                <div className="flex items-center gap-1.5 px-4 py-4 border-b border-gray-800">
                  <Image src="/images/danverse-logo.png" alt="DANVERSE logo" width={44} height={44} className="h-11 w-11 object-contain" />
                  <span className="font-semibold tracking-wide text-white text-lg">DANVERSE ArchViz</span>
                </div>
