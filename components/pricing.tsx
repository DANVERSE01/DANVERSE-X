    ...
    >
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(245,245,0,0.14) 0%, rgba(245,245,0,0.04) 20%, rgba(245,245,0,0) 82%, rgba(245,245,0,0.08) 100%)",
          }}
        />
      </div>
      ...
      <div className="container relative mx-auto px-4 py-24 sm:py-28 lg:py-32">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="section-label" style={{ fontFamily: "var(--font-process-body)" }}>
              The Process
            </p>
            <h2
              id="process-heading"
              ref={headlineRef}
              className="section-heading mt-5 flex flex-wrap gap-x-4 gap-y-2 text-[2.8rem] leading-none text-white sm:text-[4.4rem] lg:text-[5.6rem]"
            ...
            <p
              className="body-copy mt-6 max-w-2xl text-base leading-8 sm:text-lg"
          ...
          <div ref={stepsRef} className="relative mt-10 sm:mt-12">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute bottom-10 left-8 top-6 w-px sm:left-11 lg:left-[3.25rem]"
            >
              <div className="absolute inset-0 rounded-full" style={{ backgroundColor: "rgba(245,245,0,0.16)" }} />
              <div
                ref={lineFillRef}
                className="absolute inset-0 origin-top scale-y-0 rounded-full"
                style={{
                  background:
                    "linear-gradient(180deg, rgba(245,245,0,0.2) 0%, rgba(245,245,0,0.8) 55%, rgba(245,245,0,0.16) 100%)",
                  boxShadow: "0 0 18px rgba(245,245,0,0.42)",
                }}
              />
            </div>
                ...
                return (
                  ...
                  >
                    <div className="relative flex justify-center pt-1 sm:pt-2">
                      <span
                        aria-hidden="true"
                        className="absolute left-1/2 top-[4rem] z-10 h-3 w-3 -translate-x-1/2 rounded-full bg-[rgba(5,5,7,0.48)] backdrop-blur-sm sm:top-[4.75rem] lg:top-[5.15rem]"
                        style={{
                          border: "1px solid rgba(245,245,0,0.55)",
                          boxShadow: "0 0 24px rgba(245,245,0,0.42)",
                        }}
                      />
                      <div
                        ref={(element) => {
                        ...
                        style={{ filter: "drop-shadow(0 0 18px rgba(201,168,245,0.14))" }}
                      >
                        <svg viewBox="0 0 320 180" className="h-auto w-full" aria-hidden="true">
                          <defs>
                            <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="0%">
                              <stop offset="0%" stopColor="#F5F500" />
                              <stop offset="100%" stopColor="#F5F500" />
                            </linearGradient>
                          </defs>
                          <text
                            ref={(element) => {
                    ...
                    <div
                      ...
                      className="process-card brand-card relative overflow-hidden rounded-[1.75rem] border-l-2 border-l-[var(--color-lime)] px-6 py-7 will-change-transform sm:px-8 sm:py-9 lg:px-10 lg:py-10"
                    >
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(201,168,245,0.12),transparent_38%),radial-gradient(circle_at_left,rgba(255,255,255,0.045),transparent_28%)] opacity-80" />
                      <div className="relative">
                        <div className="flex items-start justify-between gap-6">
                          <div>
                            <p
                              className="section-label text-[0.65rem]"
                              style={{ fontFamily: "var(--font-process-body)" }}
                            >
                              STAGE {step.number}
                            </p>
                            <h3
                              className="mt-4 text-2xl font-extrabold leading-none text-white sm:text-[2rem] lg:text-[2.35rem]"
                              style={{ fontFamily: "var(--font-process-display)" }}
                            >
                              {step.title}
                            </h3>
                        ...
                        <p
                          className="body-copy mt-8 max-w-3xl text-base leading-8 sm:text-lg"
                          style={{ fontFamily: "var(--font-process-body)" }}
                        >
                          {step.description}
                        </p>
                        ...
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(to right, rgba(245,245,0,0.45), rgba(255,255,255,0.08), transparent)",
                          }}
                        />
                      </div>
                    </div>
