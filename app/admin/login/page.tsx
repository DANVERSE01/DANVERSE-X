...
export default function AdminLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const validEmails = ["admin@danverse.com", "danverseai@outlook.com"]
      if (validEmails.includes(email) && password === adminPass) {
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col md:flex-row">
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-red-600 to-orange-500 p-12 flex-col justify-between">
        <div>
          <div className="flex items-center gap-3">
            <Image src="/images/danverse-logo.webp" alt="DANVERSE" width={160} height={44} className="object-contain" />
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12">
        <div className="flex md:hidden items-center gap-3 mb-8 w-full justify-center">
          <Image src="/images/danverse-logo.webp" alt="DANVERSE" width={140} height={38} className="object-contain" />
        </div>
